...
public class GamesPanel extends JPanel {
    ...
    private JPanel createFormPanel() {
        ...
        fieldsPanel.add(createFieldPanel("Descripción:", txtDescription, null));
        fieldsPanel.add(createFieldPanel("Géneros:", txtGenres, lblGenresError));
